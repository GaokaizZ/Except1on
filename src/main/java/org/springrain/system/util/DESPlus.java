...
public class DESPlus {
	...
	private final static String strDefaultKey = "y1h2z3z4";
	...
	/***************************************************************************
	 * function: DES parameter: u_char * key ; key for encrypt u_char * mtext ; encipher data u_char * text ; plain data return: none
	 **************************************************************************/
	...
	public static void main(String args[]) {
		...
		DESPlus m = new DESPlus("778899");
		String s = "abc";
		// 9804400923351367378
		String miwen = m.Encode(s);
		System.out.println("加密后:[" + miwen + "]");

		String mingwen = m.Decode("37087506BF258F30").toString().trim();
		//
