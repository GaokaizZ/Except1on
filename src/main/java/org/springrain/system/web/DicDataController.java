...
public class DicDataController extends BaseController {
	...
	public @ResponseBody ReturnDatas listjson(@PathVariable String pathtypekey, HttpServletRequest request, Model model, DicData dicData) throws Exception {
	 ...
	 */
	@RequestMapping("/tree")
	public String tree(@PathVariable String pathtypekey, HttpServletRequest request, Model model, DicData dicData) throws Exception {
		if (dicData != null) {
			dicData.setTypekey(pathtypekey);
		}
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
	...
	public String tree2(@PathVariable String pathtypekey, HttpServletRequest request, Model model, DicData dicData) throws Exception {
		if (dicData != null) {
			dicData.setTypekey(pathtypekey);
		}
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
	...
	public @ResponseBody ReturnDatas lookjson(@PathVariable String pathtypekey, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
	...
	public String beforeAdd(HttpServletRequest request, Model model) throws Exception{
		...
		return "/system/dicdata/beforeAddDicData";
	}
	...
	public String beforeUpdate(HttpServletRequest request, Model model) throws Exception{
		...
		return "/system/dicdata/beforeUpdateDicData";
	}
	...
	public @ResponseBody ReturnDatas saveorupdate(@PathVariable String pathtypekey, @RequestParam(required=false) MultipartFile uploadFile,Model model, DicData dicData, HttpServletRequest request, HttpServletResponse response) throws Exception {
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		...
		try {
			...
			dicData.setTypekey(pathtypekey);
			id = dicDataService.saveorupdateDicData(dicData, pathtypekey);
			if (uploadFile!=null && uploadFile.getSize()>0) {
				if ("1".equals(id)) id=dicData.getId();
...
//				String extensionName = fileName.substring(fileName.lastIndexOf(".") + 1);
	...
	public @ResponseBody ReturnDatas delMultiRecords(@PathVariable String pathtypekey, HttpServletRequest request, Model model) {
