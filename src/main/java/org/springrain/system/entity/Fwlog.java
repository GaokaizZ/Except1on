...
public class Fwlog  extends BaseEntity {
    ...
    */
	...
	@Id
	@WhereSQL(sql = "id=:Fwlog_id", column = "ID")
	...
	@WhereSQL(sql = "startDate=:Fwlog_startDate", column = "START_DATE")
	...
	@WhereSQL(sql = "strDate=:Fwlog_strDate", column = "STR_DATE")
	...
	@WhereSQL(sql = "tomcat=:Fwlog_tomcat", column = "TOMCAT")
	...
	@WhereSQL(sql = "userCode=:Fwlog_userCode", column = "USER_CODE")
	...
	@WhereSQL(sql = "userName=:Fwlog_userName", column = "USER_NAME")
	...
	@WhereSQL(sql = "sessionId=:Fwlog_sessionId", column = "SESSION_ID")
	...
	@WhereSQL(sql = "ip=:Fwlog_ip", column = "IP")
	...
	@WhereSQL(sql = "fwUrl=:Fwlog_fwUrl", column = "FW_URL")
	...
	@WhereSQL(sql = "menuName=:Fwlog_menuName", column = "MENU_NAME")
	...
	@WhereSQL(sql = "isqx=:Fwlog_isqx", column = "ISQX")
