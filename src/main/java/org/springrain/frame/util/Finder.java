...
public class Finder {
	...
	public Finder(StringBuffer sb) {
		this.sql.append(sb);
	}
	
	public Finder(StringBuilder sb) {
		this.sql.append(sb);
	}
	...
	/**
	 * 根据 Entity(分表)或者Class返回查询语句的Finder 等同 getSelectFinder(User.class)==return new Finder("SELECT * FROM t_User ");
	 * 
	 * @param object
	 * @return
	 * @throws Exception
	...
	/**
	 * 根据 Entity(分表)或者Class返回更新语句的Finder 等同 getUpdateFinder(User.class,"id,name")==return new Finder("SELECT id,name FROM t_User ");
	 * 
	 * @param object
	 *            ,updatesql
	 * @return
	...
	public static Finder getSelectFinder(Object object, String selectsql) throws Exception {
		...
		Finder finder = new Finder("SELECT ").append(selectsql).append(" FROM ").append(tableName).append(" ");
		return finder;
	}

	/**
	 * 根据 Entity(分表)或者Class返回更新语句的Finder 等同 getUpdateFinder(User.class)==return new Finder("UPDATE t_User SET ");
	 * 
	 * @param object
	 * @return
	 * @throws Exception
	...
	/**
	 * 根据 Entity(分表)或者Class返回更新语句的Finder 等同 getUpdateFinder(User.class,"name=:name")==return new Finder("UPDATE t_User SET name=:name ");
	 * 
	 * @param object
	 *            ,updatesql
	 * @return
	...
	public static Finder getUpdateFinder(Object object, String updatesql) throws Exception {
		...
		String tableName = getTableName(object);
		Finder finder = new Finder("UPDATE ").append(tableName).append(" SET ");
	...
	/**
	 * 根据 Entity(分表)或者Class返回删除语句的Finder 等同 getDeleteFinder(User.class)==return new Finder("DELETE FROM  t_user ");
	 * 
	 * @param object
	 * @return
	 * @throws Exception
	...
	public static Finder getDeleteFinder(Object object) throws Exception {
		...
		String tableName = getTableName(object);
		Finder finder = new Finder("DELETE FROM  ").append(tableName).append(" ");
		return finder;
	}
