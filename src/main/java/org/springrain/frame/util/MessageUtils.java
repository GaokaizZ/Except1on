...
public class MessageUtils {
	...
	public static final String ALREADY_EXISTS = ResourceUtils.getString("already_exists");// 数据已经存在

	public static final String ADD_SUCCESS = ResourceUtils.getString("add_success");// 数据添加成功
	public static final String ADD_ERROR = ResourceUtils.getString("add_error");// 数据添加失败
	public static final String ADD_WARNING = ResourceUtils.getString("add_warning");// 名称已被使用
	...
	public static final String UPDATE_WARNING = ResourceUtils.getString("update_warning");// 数据修改异常

	public static final String SELECT_SUCCESS = ResourceUtils.getString("select_success");// 数据查询成功
	public static final String SELECT_ERROR = ResourceUtils.getString("select_error");// 数据查询异常

	public static final String DELETE_SUCCESS = ResourceUtils.getString("delete_success");// 数据删除成功
	public static final String DELETE_ERROR = ResourceUtils.getString("delete_error");// 数据删除警告
	...
	public static final String DELETE_ALL_ERROR = ResourceUtils.getString("delete_all_error");// 批量数据删除失败
	...
	public static final String CALLSERVICE_SUCC = ResourceUtils.getString("call_service_succ");// 服务调用成功

	public static final String CALLSERVICE_ERROR = ResourceUtils.getString("call_service_error");// 服务调用成功
