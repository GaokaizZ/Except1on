       ...
       */
		...
		if (result != null && this.requiredType != null && !this.requiredType.isInstance(result)) {
			...
			try {
				...
				String pattern = "Type mismatch affecting row number '{0}' and column type '{1}': {2}";
				throw new TypeMismatchDataAccessException(MessageFormat.format(pattern, rowNum, rsmd.getColumnTypeName(1), ex.getMessage()));
			}
		}
		return (T) result;
