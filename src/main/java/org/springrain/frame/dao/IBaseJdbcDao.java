...
/**
 * 基础的Dao接口,所有的Dao都必须实现此接口,每个数据库都需要一个实现.</br> 例如 demo数据的实现接口是org.springrain.springrain.dao.IBasespringrainDao,demo2数据的实现接口是org.springrain.demo2.dao.IBasedemo2Dao</br>
 * 
