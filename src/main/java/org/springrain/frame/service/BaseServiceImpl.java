...
/**
 * 基础的Service父类,所有的Service都必须继承此类,每个数据库都需要一个实现.</br> 例如 demo数据的实现类是org.springrain.springrain.service.BasedemoServiceImpl,demo2数据的实现类是org.springrain.demo2.service.Basedemo2ServiceImpl</br>
 * 
...
public abstract class BaseServiceImpl extends BaseLogger implements IBaseService {
	 ...
	 * @throws Exception
	 */
	private File createExceFile(Template template, File ffile, File excelFile, boolean first, boolean end, Map map) throws Exception {
		Writer out = null;
		try {
	...
	@Override
	public <T> String saveImportExcelFile(File excelFile, Class<T> clazz, boolean istest) throws Exception {
