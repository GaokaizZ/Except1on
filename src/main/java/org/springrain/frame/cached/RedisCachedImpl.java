...
public class RedisCachedImpl implements ICached {
	...
	@Override
	public Set<Object> getKeys(final byte[] keys) throws Exception {
	...
	@Override
	public Set<Object> getHashKeys(final byte[] key) throws Exception {
		return redisTemplate.execute(new RedisCallback<Set<Object>>() {
			@Override
			public Set<Object> doInRedis(RedisConnection connection) throws DataAccessException {
	...
	@Override
	public List<Object> getHashValues(final byte[] key) throws Exception {
