...
public class BaseController extends BaseLogger {
		...
		*/
		...
		binder.registerCustomEditor(Integer.class, new PropertyEditorSupport() {
			...
			public void setAsText(String value) {
				try {
					if (StringUtils.isNotBlank(value)) {
						setValue(NumberUtils.toInt(value));
					} else {
						setValue(null);
					}
				} catch (Exception e) {
		...
		binder.registerCustomEditor(Long.class, new PropertyEditorSupport() {
			...
			public void setAsText(String value) {
				try {
					if (StringUtils.isNotBlank(value)) {
						setValue(NumberUtils.toLong(value));
					} else {
						setValue(null);
					}
				} catch (Exception e) {
		...
		binder.registerCustomEditor(Double.class, new PropertyEditorSupport() {
			...
			public void setAsText(String value) {
				try {
					if (StringUtils.isNotBlank(value)) {
						setValue(NumberUtils.toDouble(value));
					} else {
						setValue(null);
					}
				} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public HttpServletResponse downFile(HttpServletResponse response, String filePath, boolean isOnLine, boolean delFile) throws Exception {
