...
public class ShiroUser implements Serializable {
	 ...
	 */
	private UserOfficeDTO userOfficeDTO;
	
	private Role role;
	
	/**
	 * @return the userOfficeDTO
	 */
	public UserOfficeDTO getUserOfficeDTO() {
		return this.userOfficeDTO;
	}

	/**
	 * @param userOfficeDTO the userOfficeDTO to set
	 */
	public void setUserOfficeDTO(UserOfficeDTO userOfficeDTO) {
		this.userOfficeDTO = userOfficeDTO;
	}
