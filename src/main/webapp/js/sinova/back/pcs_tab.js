...
function pcstabadd(num){  
	...
	$(".myli").show();
	if(num==1){
		$(".pcs_tab_ul").append('<li class="myli cur" id="myli'+num+'"><a href="javascript:history.go(-1)"><span id="iispan1"><p class="myspan" idnum="'+num+'" id="myspan'+num+'">'+tabtext[num]+'</p></span></a></li>');	
		}else{
		$(".pcs_tab_ul").append('<li class="myli cur" id="myli'+num+'"><a href="javascript:history.go(-1)"><span><p class="myspan" idnum="'+num+'" id="myspan'+num+'">'+tabtext[num]+'</p></span></a></li>');}	
