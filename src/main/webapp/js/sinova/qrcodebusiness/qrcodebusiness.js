...
jQuery(document).ready(function(){
	...
	$(".sub_left_menu tbody tr").click(function() {
		...
		var _url = ctx + "/qrcodebusiness/look/json?id=" + $(this).attr("id");
...
// 删除一条
function deleteQrcodeBusiness() {
	var id = jQuery("#id").val();
	if (!id || id == "") {
		myalert("请选择你要删除的记录");
		return;
	} else {
		var _url = ctx + "/qrcodebusiness/delete?id=" + id;
		var listurl = ctx + "/qrcodebusiness/list";
...
function deleteMore(){
	...
	var url = ctx + "/qrcodebusiness/delete/more";
